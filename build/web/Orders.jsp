...
if(ss!=null){
 ...
 <% } else  if(ss.equalsIgnoreCase("NotInserted")) {%>    
   ...
   <script>  window.alert(" Order Updated Successfully");</script>    <% }
   else  if(ss.equalsIgnoreCase("NotUpdated")) {%>    
   <script>  window.alert(" Order Updating Failed");</script>    <% }
...
%>
 ...
 <h4 class="card-title"><a href="Orders.jsp?st=cartde">View Cart details </a></h4>
               <% 
...
%>      
 ...
 <form class="form-sample" action="Orders.jsp?st=process" method="post"> 
  ...
  <th>  Order ID  </th> <th>  pid  </th> <th>  sid  </th> <th>  rid </th> <th>   Buyer </th>   <th>   Seller </th>   
  ...
  <th>  Created Date  </th> 
          ...
          //String sql="SELECT * FROM orderdetails where sellername='"+email+"'";
...
<tr>
  ...
  <td>  
   ...
   <a href="Orders.jsp?st=viewcartde&oid=<%=rs.getString(9)%>"><%=rs.getString(9)%> </a> 
  </td> 
...
<%}  %>  
    ...
    %> 
     ...
     <h4 class="card-title">Update Item</h4>
                 <% 
          String sql="SELECT * FROM orderdetails where addby='MANAGER' ";
          Statement stmt=connect.createStatement();
				 ResultSet rs =stmt.executeQuery(sql);
					String idname="";
                                        %>
                                         <div class="row">
                                             <form action="Orders.jsp?st=updated" method="post">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                              ...
                              <input type="text" class="form-control" name="namea" value="<%=rs1.getString(3)%>" required />
                          </div>
                        </div>
                      </div>
                    </div>
...
<%}
                    ...
                    <option value="UPI">UPI</option>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                                <%
  String sql="select sum(price) from cart where addby='MANAGER' and caid='nill'";
 ...
 <h4 class="card-title">View Cart Details</h4>
  ...
  <th>  price  </th>     <th>  Action </th>  </tr>
                      ...
                      <tbody>
                 <% 
          String sql="SELECT * FROM cart where addby='Manager' and Caid='nill'";
          Statement stmt=connect.createStatement();
				 ResultSet rs =stmt.executeQuery(sql);
					String utype="";
				 while (rs.next()) {        
