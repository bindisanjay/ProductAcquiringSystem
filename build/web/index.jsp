        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu"> 
                <li class="nav-item"> <a class="nav-link" href="employeelogin.jsp">Employee</a></li>
                <li class="nav-item"> <a class="nav-link" href="managerlogin.jsp">Manager</a></li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#auth" aria-expanded="false" aria-controls="auth">
              <i class="icon-head menu-icon"></i>
              <span class="menu-title">Manager Register</span>
              <i class="menu-arrow"></i>
            </a>
