...
<head>
  ...
  <title>PAS-Product Order Summary </title> 
...
<body>
 ...
 try{
   ...
   %>
                          ...
                          <h4 class="card-title">Generate Order Summary</h4>
                    <div id="GFG" class="table-responsive">
                    <table class="table table-striped">
                      <thead>
  <tr>  <th>  ID  </th>   <th>  username </th>  <th> Email ID </th> 
  <th>  Address  </th>  <th>  Phone </th>
  <th>  Payment Method  </th>  <th>  Total Price </th> 
  <th>  Payment Details  </th>  <th>  CartOderid  </th>     <th>  Add By </th> <th>  Modify Date </th> </tr>
                      </thead>
                      <tbody>
                 <%
          ...
          Statement stmt=connect.createStatement();
				 ResultSet rs =stmt.executeQuery(sql);
					int utype=0;
                while (rs.next()) {       utype+=  Integer.parseInt(rs.getString(7));
%>                           
<tr>
