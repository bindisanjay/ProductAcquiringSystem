   ...
   <script>  window.alert("Registation Unsuccessfully");</script>    <% }}  %>
              ...
              <form class="pt-3" action="./register" method="post" >
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  <select name="sq" class="form-control form-control-lg" id="exampleFormControlSelect2" required="true">
                    ...
                    <option value="What was your favorite school teacher?s name?">What was your favorite school teacher name?</option>
                    <option value="What?s your favorite movie?">What ix s your favorite movie? </option>
                    <option value="What was your first car?">What was your first car? </option>
                    <option value="What is your pet name?">What is your pet name?</option>
                    <option value="What is your favorite vilan?">who is your favorite hero?</option>
                  </select>
                </div> 
                   <div class="form-group">
                ...
                <div class="text-center mt-4 font-weight-light">
                  Already have an account? <a href="managerlogin.jsp" class="text-primary">Login</a>
                </div>
              </form>
            </div>
          </div>
