...
String filee=f11.getName();  System.out.println("file   ::"+filee);
...
Employee emp=new Employee();
            String ss=emp.AddEmployee(ff1, ff2, ff3, ff4, ff5, ff6, ff7, ff8, ff9, ff10, pa, ff12);
            
            if(ss.equalsIgnoreCase("Inserted")){
	                ;
                    response.sendRedirect("addemployee.jsp?v="+ss+"");
            }else{
                response.sendRedirect("addemployee.jsp?v="+ss+"");
            }
