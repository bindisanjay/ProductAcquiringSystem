...
<head>
  ...
  <title>PAS-Product  Send Email Message </title> 
...
%>
             ...
             <% 
                  String csql="SELECT count(*) FROM messages where Buyer='"+iid+"' and selller='"+email+"' ";
          ...
          String sql="SELECT * FROM messages where Buyer='"+iid+"' and selller='"+email+"' ";
 ...
 <%=idname%> <br>
                       <%} 
                                        ...
                                        %>   
                                              ...
                                              <div class="row">
                                             <form action="Erequests.jsp?st=updatemessage" method="post">  
                                <textarea name="descr" class="form-control"   required=""> </textarea>
                                <input type="hidden" value="<%=iid%>" name="buyer">
                                <input type="hidden" value="<%=email%>" name="seller">
