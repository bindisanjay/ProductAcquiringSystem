...
if(ss!=null){
   ...
   <script>  window.alert("invalid Email id And Password");</script>
 <% } else  if(ss.equalsIgnoreCase("NotInserted")) {%>    
   <script>  window.alert("login Unsuccessfully");</script>    <% }}  %>
                
              <h4>Hello! let's get started</h4>
              <h6 class="font-weight-light">Sign in to continue.</h6>
              <form action="./Elogin" method="post" class="pt-3">
                ...
                <div class="text-center mt-4 font-weight-light">
                  ...
                  <a href="employeeforgot.jsp" class="auth-link text-black">Forgot password?</a>
                </div>  
              </form>
            </div>
          </div>
