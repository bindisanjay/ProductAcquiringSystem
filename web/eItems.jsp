                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-group row"> 
                          <div class="col-sm-9"> 
                              ...
                              <input type="hidden" class="form-control" name="roles" value="Buyer">
...
<% }else  if(st.equalsIgnoreCase("delete")) {
  ...
  <th>  Category  </th>     <th>  Action </th>  </tr>
                      ...
                      <tbody>
                 <% 
          String sql="SELECT * FROM item where addby='"+email+"'";
          Statement stmt=connect.createStatement();
				 ResultSet rs =stmt.executeQuery(sql);
					String utype="";
				 while (rs.next()) {        
...
%>  
          ...
          <input type="hidden" class="form-control" name="rolee" value="<%=email%>">
          <input type="hidden" class="form-control" name="roles" value="Buyer">
